...
![Tests](https://img.shields.io/badge/tests-2967%20collected-brightgreen)
![Mypy](https://img.shields.io/badge/mypy-strict%3A%20103%2F172%20modules-blue)
...
cyberai status          # provider, output, trust boundary, sampling, air-gap, credentials, toolchain, run controls
