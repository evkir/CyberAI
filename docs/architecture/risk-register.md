...
| 4 | The published score came from a surface profile blind on both live targets | closed | entrypoint | `tests/unit/test_the_manifest_records_the_surface_it_saw.py::test_the_manifest_carries_the_profile` |
